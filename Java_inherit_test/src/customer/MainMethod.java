...
//		com.mysql.cj.jdbc.Driver
		...
		// 쿼리문 작성하기 보내기 받기
				...
				// Statement(한 번), PreparedStatment(여러 번)
...
//		menu[6].pieceFruit();
		...
		// 10000을 가지고 온다. 그러니까 10000-3500 된다. 
		// 이것의 결과 6500을 setMoney를 통해 money변수에 저장하게 되니 money 변수는 6500을 가진다.
//		getMoney(남은잔액)을 setMoney으로 받아야 함.
		
		ctm1.setBuyDate(new Date());
		ctm1.setItem(menu[num-1]);//내가 선택한 음료는 num-1
