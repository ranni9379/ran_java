...
<% 
	String path= "http://localhost:8080/jsp3/";
%>    
...
<link rel="icon" href="http://localhost:8080/jsp3/static/images/loveicon.ico">
<link rel="stylesheet" href="http://localhost:8080/jsp3/static/css/defalt.css">
<link rel="stylesheet" href="http://localhost:8080/jsp3/static/css/signUp.css">
	...
	<div id="wrap">
		...
		<form method="post" action="signUpsave.jsp">
			...
			<div id="formData">
				...
				<div class="inputField">
					<input type="password" id="password" name="password" class="pwChk">
